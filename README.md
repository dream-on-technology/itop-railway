### ⚠️ `config/wazuh_indexer/internal_users` contains demo credentials. Don't forget to remove them before deploying on production. These credentials are publicly accessible !!! ⚠️
